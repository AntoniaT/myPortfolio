export const cardsData = [
    ...
    },
    {
        ...
        problem: "This was a first-semester group project at KEA, my university. We had to come up with an innovative app and develop it step-by-step. With this project we developed an understanding for the iterative design process and user centered design thinking. The problem we were trying to solve, was the following: People living on a budget often fall short on ideas of what to cook after a long day at work or school. They end up eating fast food and wasting the food in their fridge. Mixeat App solves that problem!",
        leftTitle: 'Personas',
        leftImg: '../images/Persona1.png',
        leftCopy: 'After our customer research, we ended up with two types of characters, which we captured in our personas. Where one is an extrovert and eager to engage in social happenings, the other is an introvert, mainly purchasing the application in order to create recipes and find online deals. Despite the difference between the two, our personas represent our major target audience of young adults. Personalities, backgrounds, goals and values are based on both qualitative and quantitative research we conducted on young people in Copenhagen.',
    ...
    },
    {
        ...
        mainCopy:'This project revolved around creating a dynamic infographic in form of a timeline. The overall purpose of the timeline I created is to visualize the change of human means of transport over time and its effects on our environment. To simplify the timeline as being part of this school project I decided to show only data which was accessible and easily comparable (Inventor, date of invention and a short explanation).',
